...
* We will explain the utility of each of the following element in the repository. 
        ...
        . *library*: This directory contains a module named 'ruddersettings' which will be used in one of Rudder configuration tasks, this module allows setting up some parameters using Rudder APIs calls.

        . *tasks*: This directory includes tasks for installing and configuring Rudder.

        . *vars*: Contains variables used in Rudder installation tasks.
